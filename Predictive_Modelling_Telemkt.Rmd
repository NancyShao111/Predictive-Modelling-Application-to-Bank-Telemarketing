...
```
Yes. For both the accuracy of the training dataset and the test dataset, if two accuracy rates are close or even lower than the probabiliry of saying 'no' to all the observations in our original dta_bank data (that is close or lower than 0.887), then it means the model probably has the problem of underfitting.
